...
#ifndef FLUTTER_GUESS_THE_NUMBER_SWIFT_H
#define FLUTTER_GUESS_THE_NUMBER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_guess_the_number",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC24flutter_guess_the_number11AppDelegate")
...
SWIFT_CLASS("_TtC24flutter_guess_the_number17MainFlutterWindow")
